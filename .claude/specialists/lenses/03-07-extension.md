...
> Repo lens alongside the agent definition for specialist 03-07 in the `team-alpha` plugin:
> `~/.claude/plugins/marketplaces/claude-code-specialists/plugins/teams/team-alpha/agents/03-07-agent.md`.
