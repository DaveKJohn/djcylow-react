...
# 06-16 · repo lens (VUL-IN)

> Repo lens alongside the agent definition for specialist 06-16 in the `dkj-subagents-alpha` plugin:
> `~/.claude/plugins/marketplaces/dkj-claude-plugins/plugins/dkj-subagents/dkj-subagents-alpha/agents/06-16-agent.md`.
> Created by `specialists-init` as empty template; agent definition reads it automatically.
> Fill in repo-specific tasks and context below that specialist 06-16 needs in this repo.
