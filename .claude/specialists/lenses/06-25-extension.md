...
> Repo lens alongside the agent definition for specialist 06-25 in the `team-alpha` plugin:
> `~/.claude/plugins/marketplaces/claude-code-specialists/plugins/teams/team-alpha/agents/06-25-agent.md`.
