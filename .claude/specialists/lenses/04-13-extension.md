...
> Repo lens alongside the agent definition for specialist 04-13 in the `dkj-subagents-alpha` plugin:
> `~/.claude/plugins/marketplaces/dkj-claude-plugins/plugins/dkj-subagents/dkj-subagents-alpha/agents/04-13-agent.md`.
> Created by `specialists-init` as empty template; agent definition reads it automatically.
> Fill in repo-specific tasks and context below that specialist 04-13 needs in this repo.
