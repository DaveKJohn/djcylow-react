...
# 06-17 · repo lens (VUL-IN)

> Repo lens alongside the agent definition for specialist 06-17 in the `dkj-subagents-alpha` plugin:
> `~/.claude/plugins/marketplaces/dkj-claude-plugins/plugins/dkj-subagents/dkj-subagents-alpha/agents/06-17-agent.md`.
> Created by `specialists-init` as empty template; agent definition reads it automatically.
> Fill in repo-specific tasks and context below that specialist 06-17 needs in this repo.
