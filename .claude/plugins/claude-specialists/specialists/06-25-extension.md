...
> Repo-lens for the portable manual of specialist 06-25 in the `specialists` plugin. This file was put
> in place by `sync-roster` as an empty template; the agent-def reads it along automatically.
> Fill in below the repo-specific tasks and context specialist 06-25 needs in this repo.
