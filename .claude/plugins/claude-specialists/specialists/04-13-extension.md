...
# Cody · repo-lens (VUL-IN)

> Repo-lens bij het draagbare vakboek van Cody in de `specialists`-plugin. Dit bestand is
> door `specialists-init` als leeg sjabloon neergezet; de agent-def leest het automatisch mee.
> Vul hieronder de repo-specifieke taken en context aan die Cody in deze repo nodig heeft.
