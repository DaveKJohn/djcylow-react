...
# Vera · repo-lens (VUL-IN)

> Repo-lens bij het draagbare vakboek van Vera in de `specialists`-plugin. Dit bestand is
> door `specialists-init` als leeg sjabloon neergezet; de agent-def leest het automatisch mee.
> Vul hieronder de repo-specifieke taken en context aan die Vera in deze repo nodig heeft.
