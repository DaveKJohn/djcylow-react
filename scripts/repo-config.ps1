...
# lint-web.ps1 checkt nu alleen `tsc --noEmit`; ESLint hoort erbij te komen nu de achterstand op 0
# staat (2026-08-14) -- de afweging staat in de header van dat script.
