...
De grote wijziging is zichtbaar op de site: alle 77 publieke mixen hebben een nieuwe, unieke titel
gekregen. Waar eerder 63 mixen elf titels deelden en dus met een identieke `<h1>` en `<title>` op
zoekmachines terechtkwamen, draagt nu elke mix een eigen naam waarin het subgenre meedoet.
Daarnaast zijn drie mixen gecorrigeerd die een andere frequentie toonden dan hun eigen data.
