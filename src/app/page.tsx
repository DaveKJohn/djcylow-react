    ...
    return (
        <main>
            ...
            <section className="column index text-wrapper spacing-h1">
                ...
                <div className="column wrapper stack WoB" id="hero">

                    <div className="column wrapper layer back"></div>


                    <div className="column wrapper layer middle">
                        <img
                    ...
                    <div className="column text-constrainer spacing-h3 layer front">

                        <div className="column text-wrapper spacing-h9">
                            <h1>{homeContent.title}</h1>
                            <h2 dangerouslySetInnerHTML={{ __html: homeContent.subtitle || "" }} />
                        </div>

                        <div className="row wrapper spacing-h7 button-group">
                ...
                <div className="column wrapper center WoB" id="promo">
                    <div className="column constrainer">
                        <div className="column text-wrapper spacing-h6">
                            ...
                            <div className="row wrapper flex spacing-h5 v-start">
                                ...
                                <div className="column text-wrapper spacing-h7 right story h-start" id="promo_story">
                                    <ReadMore
                    ...
                    <div className="constrainer">
                        <div className="column text-wrapper spacing-h6 flex">
                            ...
                            <div className="row wrapper flex spacing-h5 v-start">
                                ...
                                <div className="column text-wrapper spacing-h7 right story h-start" id="verzoeknummers_story">
                                    <ReadMore
                                        teaser={
