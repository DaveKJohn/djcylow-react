...
export default function ContactForm() {
    ...
    return (
        <div className="column wrapper center BoW v-push-7xl" id="contactformulier">
            <div className="constrainer column spacing-xl">
                <div className="column wrapper spacing-2xl show_border_bottom">
                ...
                <div className="column wrapper spacing-4xl h-push-5xl">
                    {status === "success" ? (
                        <div className="column wrapper spacing-xl center show_border_bottom" id="succesMessage">
                            <div className="column text-wrapper center spacing-lg">
                        ...
                        <form
                            ref={formRef}
                            className="column wrapper spacing-xl form-wrapper show_border_bottom"
                            id="contactForm"
                    ...
                    {/* WhatsApp Sectie */}
                    <div className="column wrapper spacing-lg h-push-5xl">
