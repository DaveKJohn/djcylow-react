  ...
  return (
    <footer className="column WoB black-90-bg">
      <div className="constrainer column constrainer center">
        <div className="column text-wrapper spacing-h3 center v-push-h2">

          <div className="column wrapper spacing-h3 center logo">
          ...
          <div className="column text-wrapper spacing-h3 center row-2">

            {/* Social Media Icons */}
            <div className="row wrapper spacing-h3 split">
            ...
            <div className="row text-wrapper spacing-h3 center flex split">
