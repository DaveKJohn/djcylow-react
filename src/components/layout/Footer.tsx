  ...
  return (
    <footer className="column WoB black-90-bg">
      <div className="constrainer column constrainer center">
        <div className="column text-wrapper spacing-m center v-push-xl">
          ...
          <div className="column text-wrapper spacing-l center row-2">
            
            {/* Social Media Icons */}
            <div className="row wrapper spacing-s split">
