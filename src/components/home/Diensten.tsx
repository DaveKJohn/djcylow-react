...
const Diensten = () => {
    return (
        <section className="column wrapper spacing-h1 WoB" id="hero">
            <div className="column wrapper center WoB" id="diensten">
                <div className="column constrainer">
                    <div className="column text-wrapper spacing-h6 center flex">
                        <div className="column text-wrapper spacing-h6 header center">
                        ...
                        <div className="row wrapper spacing-h7 wrap flex buttons">
