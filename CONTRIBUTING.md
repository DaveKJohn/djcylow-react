...
hoort niet in de poort zelf. ESLint blijft er bewust buiten: er staan 27 pre-existing errors, dus die
vergelijk je op **aantal** en niet op exitcode. Het waren er 37 tot 2026-08-14; de tien die vervielen
waren `no-require-imports` in de Node-scripts, waar CommonJS legitiem is.
